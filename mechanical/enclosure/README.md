...
| `agent-deck-v1-mx-plate.stl` | 13-key MX control plate | top face on bed for a clean touch membrane |
...
- K13 sits immediately right of the touch center at a 22.0 mm center pitch. The extra 3 mm keeps the bottom-mounted socket copper and touch quiet zone separated.
- Nominal touch-to-K13 separation: 5.9 mm plate ligament and 4.4 mm to the 17.2 mm keycap envelope.
...
- Select the exact MX switch, keycap, encoder, and knob; verify the selected Kailh socket and RKJXM candidate samples.

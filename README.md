...
- PCB 고정형 MX 호환 기계식 키 13개, Kailh 핫스왑 소켓, 키별 다이오드
- 전체 13키 개별 RGB 상태 표시
- 클릭 가능한 로터리 엔코더 1개
...
- 키 13개: 5핀 MX 호환 스위치, Kailh `CPG151101S11-16` 핫스왑 소켓, 다이오드를 포함한 4×4 매트릭스
...
- 공용 입력 PCB: 13키, 13다이오드, 키별 RGB 13개, MCP23017, EC11, 5방향 입력, AT42QT1010 터치, TPS2553 RGB 전류 제한, AHCT 레벨 시프터
